...
/usr/local/spark/bin/spark-submit --master spark://52.41.192.216:7077 --packages org.apache.spark:spark-streaming-kafka-0-8_2.11:2.0.2 /home/ubuntu/UMatch/Spark-Streaming/Location-hash.py &
